...
cd $DATA_DIR/ref && \
    ...
    wget -nc --progress=bar:force 2>&1 "https://s3-us-west-2.amazonaws.com/human-pangenomics/pangenomes/freeze/freeze1/minigraph-cactus/hprc-v1.1-mc-grch38/hprc-v1.1-mc-grch38.d9.gbz" && \
